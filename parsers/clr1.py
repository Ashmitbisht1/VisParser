"""
CLR(1) parser – builds canonical LR(1) automaton with lookahead items.
"""
from core.grammar import Grammar
from core.first_follow import compute_first, compute_follow
from parsers.lr_base import lr1_canonical_collection, LR1Item


def build_clr1_table(grammar: Grammar):
    """
    Build CLR(1) ACTION and GOTO tables.
    ...
    states, transitions = lr1_canonical_collection(grammar, first_sets)
    action_table = {}
    goto_table = {}
    conflicts = []
